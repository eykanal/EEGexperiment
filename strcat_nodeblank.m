...
%STRCAT Concatenate strings without removing trailing whitespace.
...
%   arrays.
%
%   STRCAT ignores trailing ASCII white space characters and omits all 
...
%   characters, all of which return a TRUE response from the MATLAB 
%   ISSPACE function. Use the concatenation syntax [s1 s2 s3 ...] to 
%   preserve trailing spaces. STRCAT does not ignore inputs that are 
...
%   $Revision: 1.16.4.5 $  $Date: 2008/03/17 22:19:00 $
